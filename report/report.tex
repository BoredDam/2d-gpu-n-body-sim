...
\begin{abstract}
Con la seguente relazione si documenta la realizzazione di simulazioni $n$-body tramite soluzioni parallele su GPU. Si trattano quindi aspetti degni di nota, quali gli algoritmi, i metodi numerici,  le ottimizzazioni e un'analisi delle performance.  Le soluzioni principali presentate saranno due: un'approccio naive su GPU, e un approccio approssimato Barnes-Hut, sempre su GPU.
\end{abstract}
...
\newpage
	...
	\begin{itemize}
		...
		\item \textbf{AMD Ryzen 7 7700 - gfx1036} (integrata).
	\end{itemize}
	%
	...
	\end{itemize}
	e ricordando che questo vale per un numero di work-item pari al numero di corpi, ossia $n$. Seppur sembra un'osservazione triviale, questo numero fisso di work-item (uguale al numero di corpi) non sarà presente nell'approccio Barnes-Hut proposto.
	
	Osservando i grafici delle successive pagine, emergono un paio di valutazioni. Entrambe le GPU integrate valutate performano in maniera simile sul calcolo di posizione e velocità. In generale, il calcolo di posizione e velocità cresce linearmente in funzione del numero di corpi.  
